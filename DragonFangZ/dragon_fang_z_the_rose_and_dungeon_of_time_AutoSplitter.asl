state("dfz")
{
    ...
    int cradleClearNumRAM  : "mono.dll", 0x00264110, 0xC40, 0x0, 0x78, 0x46C, 0x0, 0x20, 0x10, 0x48, 0x18;  // ゆりかごクリア回数
    ...
    int hollowClearNumRAM  : "mono.dll", 0x00264110, 0xC40, 0x0, 0x78, 0x46C, 0x0, 0x20, 0x10, 0x58, 0x18;  // 奈落クリア回数
    int friendshipClearNumRAM  : "mono.dll", 0x00268180, 0x100, 0x138, 0x344, 0x40, 0xE0, 0x10, 0x68, 0x18;  // 友絆クリア回数
    int eggClearNumRAM  : "mono.dll", 0x00264110, 0xC40, 0x0, 0x78, 0x46C, 0x0, 0x20, 0x10, 0x40, 0x18;  // たまごクリア回数
}
