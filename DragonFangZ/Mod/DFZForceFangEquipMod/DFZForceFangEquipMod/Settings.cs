...
namespace DFZForceFangEquipMod
{
    internal class Settings
    {
        ...
        public static MelonPreferences_Entry<bool> disableFang100FromStone;
        ...
        public static void init()
        {
            ...
            disableFang100FromStone = settingsCategory.CreateEntry<bool>("disableFang100FromStone", true, null, "竜石によるファングドロップ確定化を無効化する(false:しない、true:する)");
